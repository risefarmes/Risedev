...
local hash = loadstring(downloadFile('Rise6/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('Rise6/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('Rise6/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
...
vape.Libraries.auraanims = {
	...
	{CFrame = CFrame.new(-0.52, -0.82, 0.18) * CFrame.Angles(math.rad(-165), math.rad(44), math.rad(-2)), Time = 0.03}
	},
	['Funny'] = {
...
run(function()
	...
	function whitelist:update(first)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('Rise6/profiles/whitelist.json') and readfile('Rise6/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('Rise6/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
	...
	local function Added(ent)
		...
		arrow.Visible = false
		arrow.Image = getcustomasset('Rise6/assets/new/arrowmodule.png')
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getcustomasset('Rise6/assets/new/radaricon.png'),
...
run(function()
	...
	SessionInfo = vape:CreateOverlay({
		Name = 'Session Info',
		Icon = getcustomasset('Rise6/assets/new/textguiicon.png'),
	...
	Hide = SessionInfo:CreateTextList({
		...
		Icon = getcustomasset('Rise6/assets/new/blockedicon.png'),
		Tab = getcustomasset('Rise6/assets/new/blockedtab.png'),
